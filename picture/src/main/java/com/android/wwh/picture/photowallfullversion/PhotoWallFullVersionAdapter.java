...
public class PhotoWallFullVersionAdapter extends ArrayAdapter<String> {
    ...
    public PhotoWallFullVersionAdapter(Context context, int textViewResourceId, String[] objects,
                            GridView photoWall) {
